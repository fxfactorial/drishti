...
{
public:
    VideoSourceOpenCV(const std::string& filename)
    {
...
std::shared_ptr<VideoSourceCV> VideoSourceCV::createCV(const std::string& filename)
{
    return std::make_shared<VideoSourceOpenCV>(filename);
}
